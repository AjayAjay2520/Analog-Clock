...
function App() {
  const [rotation, setRotation] = useState(new Date() );

  useEffect(() => {
    const timerId = setInterval(() => {
      setRotation(new Date());
    }, 1000);
  ...
  return (
    <div className="analog">
      ...
      <div
        className="hrs line"
        style={{
          transform: `rotateZ(${rotation.getHours() * 30}deg)`,
        }}
      />
      <div
        className="min line"
        style={{
          transform: `rotateZ(${rotation.getMinutes() * 6}deg)`,
        }}
      />
      <div
        className="sec line"
        style={{
          transform: `rotateZ(${rotation.getSeconds() * 6}deg)`,
        }}
      />
